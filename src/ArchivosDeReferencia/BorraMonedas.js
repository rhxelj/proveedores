...
class BorraMonedas extends Component {
    constructor(props){
        super(props)
        this.state = {
            monedas:[],
    ...
    //Read
    read = _ => {
        const url = 'http://localhost:4000/indexmonedas'; //'http://192.168.2.102:4000/indexprov'
        request
        .get(url)
 ...
 //       const { moneda } = this.state;
        request
          .delete('http://localhost:4000/borramonedas/'+id)
          .set('Content-Type', 'application/json')
