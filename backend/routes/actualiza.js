    ...
    articulo.query('Select * from articulos where id = ' + indice,
        function(err, result) {
            if (err) {
                ...
                var formulario = '<form method="post" action="/actualiza">' +
                ...
                var cabecera = '<h1> Actualiza Datos de Artículos</h1>';
...
router.post('/', function(req, res) {
    ...
    articulo.query('Update articulos set nombre = ($1), descripcion= ($2), fecha = ($3), importe = ($4) where id = ($5)', [nombre, descripcion, fecha, importe, indice],
